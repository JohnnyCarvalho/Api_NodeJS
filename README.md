...
```
Uma API em node.js para ligação e cadastro com o banco de dados de usuários em um sistema de login e senha,\ncom authenticação, validação e recuperação de senha.
```
